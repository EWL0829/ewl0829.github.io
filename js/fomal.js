...
if (document.body.clientWidth > 992) {
  ...
  (function ($) {
    $.fn.nekoScroll = function (option) {
      var defaultSetting = {
        ...
        borderRadius: 5 + 'px',
        right: 55.6 + 'px',
        nekoImg: "https://s2.loli.net/2025/02/11/AGj3HzSLnORIs9i.png",
  ...
  $(document).ready(function () {
    ...
    //     nekoImg:'https://s2.loli.net/2025/02/11/AGj3HzSLnORIs9i.png', //neko的背景图片
    //     scImg:"img/绳1.png", //绳子的背景图片
    //     bgcolor:'#ffffff', //背景颜色，没有绳子背景图片时有效
    //     zoom:0.9, //绳子长度的缩放值
    //     hoverMsg:'你好~喵', //鼠标浮动到neko上方的对话框信息
    //     right:'100px', //距离页面右边的距离
    //     fontFamily:'楷体', //对话框字体
    //     fontSize:'14px', //对话框字体的大小
    //     color:'#ffffff', //对话框字体颜色
    //     scroWidth:'8px', //绳子的宽度
    //     z_index:100, //不用解释了吧
...
const map = new Map();
map.set('red', "rgb(233, 121, 121)");       // 柔和红
map.set('orange', "rgb(233, 181, 121)");    // 柔和橙
map.set('yellow', "rgb(233, 233, 140)");    // 柔和黄
map.set('purple', "rgb(168, 121, 220)");    // 柔和紫
map.set('blue', "rgb(140, 180, 220)");      // 柔和蓝
map.set('gray', "rgb(210, 210, 210)");      // 柔和灰
map.set('green', "rgb(120, 190, 180)");     // 柔和绿
map.set('whitegray', "rgb(230, 230, 230)"); // 柔和白灰
map.set('pink', "rgb(230, 150, 175)");      // 柔和粉
map.set('black', "rgb(40, 40, 40)");        // 柔和黑（深灰）
map.set('darkblue', "rgb(120, 125, 170)");  // 柔和深蓝
map.set('heoblue', "rgb(110, 135, 210)");   // 柔和海蓝
